function onCreate()
	-- background shit
	makeLuaSprite('bfplatform', 'platform_dark', 800, 700);
	...
	makeLuaSprite('erecttint', 'erect_tint', -200, -100)
	scaleObject('erecttint', 0.7, 0.7)
	setScrollFactor('erecttint', 0, 0)
	setBlendMode('erecttint', 'MULTIPLY')

	addLuaSprite('dojobg', false)
	addLuaSprite('bfplatform', false)
	addLuaSprite('angynesseffect', true)
	addLuaSprite('erecttint', true)
